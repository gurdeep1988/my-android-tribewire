...
public class LocalImageDownloader {
	...
	private static LocalImageDownloader imageDownloader = null;
    private static Context c;
    private static Resources res;
    
    private static Bitmap tempBitmap ;
	private LocalImageDownloader() {

	}

	public static LocalImageDownloader getInstance() {
		if (imageDownloader == null) {

			imageDownloader = new LocalImageDownloader();
		}
