...
public class StorageImageDownloader {

	private static final String LOG_TAG = "ImageDownloader";
	private final int minimumHeight = 10;

	private static StorageImageDownloader imageDownloader = null;
    private static Context c;
    private static Resources res;
    
    private static Bitmap tempBitmap ;
	private StorageImageDownloader() {

	}

	public static StorageImageDownloader getInstance() {
		if (imageDownloader == null) {

			imageDownloader = new StorageImageDownloader();
		}
	 ...
	 */
	public void download(String url, ImageView imageView, Context c) {
		StorageImageDownloader.c = c;
         ...
         try {
        	 if (res==null) {
              ...
              if (tempBitmap==null) {
     			tempBitmap = BitmapFactory.decodeResource(c.getResources(), R.drawable.no_image);
     		}
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//			final HttpEntity entity = response.getEntity();
			...
			if (c != null) {
				...
				/*	try {
						...
						cursor = c.getContentResolver().query(Uri.parse(url), projection, null, null,
								null);
...
//									// Log.e("", "Id " + contactId + " Name=" + name);
					...
					.decodeSampledBitmapFromFile(url, 120, 120);
